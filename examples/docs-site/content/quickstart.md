本页用于体验随源码提供的演示。接入自己的业务项目，请直接选择[前端 SDK](/docs/frontend/)或[后端 SDK](/docs/sdk/)，不需要先完成本地 Playground。
...
**准备自由问答：** 按[示例宿主的本地配置](/docs/local-models/)配置 .local/models.json 和 .secrets/credentials.json。已经配置过的电脑保留原文件，不需要覆盖。
